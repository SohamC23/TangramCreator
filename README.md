...
- creating infrastructure using AWS so that the website can exist on the internet.
- Persisting puzzles and presets across sessions (currently in-memory only) using AWS. The session data will be saved to the accounts created on the website.
